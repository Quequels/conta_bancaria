...
public class Menu {
	...
	public static void criarContasTeste() {
		...
		contaController.cadastrar(new ContaCorrente(contaController.gerarNumero(),789,2,"Mariana Hernandez",10000.00f, 12));
		contaController.cadastrar(new ContaCorrente(contaController.gerarNumero(),456,1,"Giovanna Giunchetti",8000.00f, 23));
	...
	private static void depositar() {
		...
		System.err.print("Digite o número da conta: ");
		int numero = leia.nextInt();
	...
	private static void transferir() {
		...
		System.out.print("Digite o número da conta do destino: ");
